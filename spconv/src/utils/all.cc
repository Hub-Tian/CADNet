...
PYBIND11_MODULE(spconv_utils, m)
{
    ...
    m.def("points_to_voxel_3d_np", &spconv::points_to_voxel_3d_np<double, 3>,
          ...
          "voxel_size"_a = 6, "coors_range"_a = 7, "max_points"_a = 8,
          "max_voxels"_a = 9);
    m.def("points_to_fv_np", &spconv::points_to_fv_np<float>,
          "matrix tensor_square", "rangeview"_a = 1, "rv_pts_3d"_a = 2, "theta"_a = 3,
          "pts_2d"_a = 4, "points"_a = 5,
          "distances"_a = 6);
    m.def("points_to_fv_np", &spconv::points_to_fv_np<double>,
          "matrix tensor_square", "rangeview"_a = 1, "rv_pts_3d"_a = 2, "theta"_a = 3,
          "pts_2d"_a = 4, "points"_a = 5,
          "distances"_a = 6);
    m.def("points_to_voxel_3d_np_expand2", &spconv::points_to_voxel_3d_np_expand2<float, 3>,
          "matrix tensor_square", "points"_a = 1, "voxels"_a = 2, "coors"_a = 3,
          "num_points_per_voxel"_a = 4, "coor_to_voxelidx"_a = 5,
          "voxel_size"_a = 6, "coors_range"_a = 7, "max_points"_a = 8,
          "max_voxels"_a = 9);
    m.def("points_to_voxel_3d_np_expand2", &spconv::points_to_voxel_3d_np_expand2<double, 3>,
          "matrix tensor_square", "points"_a = 1, "voxels"_a = 2, "coors"_a = 3,
          "num_points_per_voxel"_a = 4, "coor_to_voxelidx"_a = 5,
          "voxel_size"_a = 6, "coors_range"_a = 7, "max_points"_a = 8,
          "max_voxels"_a = 9);
