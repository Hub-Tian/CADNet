...
def build_network(dataset,expand):
...
def model_fn_decorator():
    ...
    def model_func(model, data):
        ...
        # add flops calculator
        # from thop import profile
        # macs, params = profile(model, inputs=(input_dict,))
...
def example_convert_to_torch(example, dtype=torch.float32):
    ...
    example_torch = {}
    float_names = [
        'voxels', 'voxels_expand', 'anchors', 'box_reg_targets', 'reg_weights', 'part_labels',
    ...
    for k, v in example.items():
        ...
        elif k in ['coordinates', 'box_cls_labels', 'num_points', 'num_points_expand', 'seg_labels']:
