...
class KittiDataset(BaseKittiDataset):
    def __init__(self, root_path, class_names, split, training, logger=None, expand=None):
        """
    ...
    def dataset_init(self, class_names, logger):
        ...
        try:
            ...
            ret_list = self.voxel_generator.generate(points)
        except:
    ...
    def __getitem__(self, index):
        ...
        example = self.prepare_data(input_dict=input_dict, has_label='annos' in info, expand=self.expand)
